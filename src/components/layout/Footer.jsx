  ...
  return (
    ...
    >
      ...
      <div className="md:hidden px-5 pt-8 pb-7 space-y-6 relative z-10">
        ...
        {/* Event Date Chip */}
        <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.06] border border-gold-500/20">
          ...
          {quickLinks.map((item) =>
            item.href ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl bg-white/5 active:bg-white/10 active:scale-95 border border-white/[0.08] text-white/80 flex items-center justify-between transition-all duration-200"
              >
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="flex-1 py-2.5 px-3 rounded-xl bg-white/5 active:bg-white/10 active:scale-95 border border-white/[0.08] text-[0.71875rem] font-body text-white/80 flex items-center justify-center gap-1.5 truncate transition-all duration-200"
          >
          ...
          <a
            ...
            className="flex-1 py-2.5 px-3 rounded-xl bg-white/5 active:bg-white/10 active:scale-95 border border-white/[0.08] text-[0.71875rem] font-body text-white/80 flex items-center justify-center gap-1.5 transition-all duration-200"
          >
        ...
        {/* Copyright */}
        <div className="pt-4 border-t border-white/[0.08] flex items-center justify-between text-[0.6875rem] text-white/40 font-body">
      ...
      <div className="hidden md:block w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 pt-14 pb-8 relative z-10">
        ...
        <div className="flex items-start justify-between gap-8 pb-10 border-b border-white/[0.08]">
          ...
          <div className="flex flex-col items-end gap-2.5 shrink-0">
            <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-white/[0.06] border border-gold-500/25">
              <CalendarDays className="w-4 h-4 text-gold-400 shrink-0" />
              <div className="flex flex-col items-end">
                <span className="font-body text-xs text-gold-400 font-semibold tracking-[0.1em] uppercase">Convocation Day</span>
                <span className="font-display font-bold text-white text-sm leading-tight">26 September 2026</span>
              </div>
            </div>
            <span className="font-body text-xs text-white/40 flex items-center gap-1.5">
        ...
        {/* 3+1 col link grid */}
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-10 lg:gap-12 py-10 border-b border-white/[0.08]">

          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-body font-semibold text-xs text-gold-400 tracking-[0.14em] uppercase">
              Quick Links
            </h3>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
              {/* Address */}
              <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-white/5 border border-white/[0.08]">
                <div className="w-8 h-8 rounded-xl bg-gold-500/20 border border-gold-500/25 flex items-center justify-center shrink-0">
                  <MapPin className="w-3.5 h-3.5 text-gold-400" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.65rem] text-white/40 uppercase tracking-widest font-semibold">Address</span>
              ...
              <a
                href="mailto:convocation@iiitbh.ac.in"
                className="flex items-start gap-3 p-3.5 rounded-2xl bg-white/5 border border-white/[0.08] hover:bg-white/[0.08] hover:border-gold-500/25 transition-all duration-200 group"
              >
                <div className="w-8 h-8 rounded-xl bg-gold-500/20 border border-gold-500/25 flex items-center justify-center shrink-0">
                  <Mail className="w-3.5 h-3.5 text-gold-400" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.65rem] text-white/40 uppercase tracking-widest font-semibold">Email</span>
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.65rem] text-white/40 uppercase tracking-widest font-semibold">Phone</span>
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.65rem] text-white/40 uppercase tracking-widest font-semibold">Website</span>
                  <span className="font-body text-[0.8125rem] text-white/70 group-hover:text-gold-400 transition-colors duration-200">
                    www.iiitbh.ac.in
                  </span>
                </div>
