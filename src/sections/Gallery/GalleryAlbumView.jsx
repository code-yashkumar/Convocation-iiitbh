...
export const ALBUMS_CONFIG = {
  'degree-distribution': {
    ...
    defaultDriveUrl: 'https://drive.google.com/drive/u/3/folders/1R-c4xV0crbNjCzuOWkCi5y2vytPULigu',
    photos: [
      {
        id: 1,
  ...
  'alumni-meet': {
    ...
    photos: [
      ...
      {
        id: 4,
        title: 'Alumni Association Board Meeting',
        caption: 'Constitution of regional chapters and student endowment scholarship initiatives.',
        url: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=1200&auto=format&fit=crop',
        tag: 'Initiatives',
      },
      {
        id: 5,
        title: 'Group Photo with Director & Faculty',
        caption: 'Commemorative alumni assembly photograph at the permanent campus.',
        url: 'https://images.unsplash.com/photo-1577495508048-b635879837f1?q=80&w=1200&auto=format&fit=crop',
        tag: 'Group Photo',
      },
      {
        id: 6,
        title: 'Networking High Tea & Mementos',
        caption: 'Presenting alumni mementos and honorary citations for corporate achievements.',
  ...
  'speaker-session': {
    ...
    subtitle: 'Visionary keynote address, ceremonial speeches, and inspiring thoughts delivered by chief guests and institute leaders.',
    ...
    photos: [
      {
        ...
        caption: 'Prof. T N Singh (Director, IIT Patna) delivering the convocation presidential address.',
        url: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?q=80&w=1600&auto=format&fit=crop',
        tag: 'Keynote Address',
      },
      {
        id: 2,
        title: 'Director’s Annual Institute Report',
        caption: 'Prof. Madhusudan Singh presenting achievements in research, patents, and campus development.',
        url: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?q=80&w=1200&auto=format&fit=crop',
        tag: 'Director Report',
      },
      {
        id: 3,
        title: 'Guest of Honour Address to Cohort',
        caption: 'Prof. Pragati Kumar addressing the graduates on engineering ethics and AI innovation.',
        url: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=1200&auto=format&fit=crop',
        tag: 'Guest of Honour',
      },
      {
        id: 4,
        title: 'Senate Assembly & Degree Ratification',
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          >
            ...
            <span>Open Google Drive Album (High-Res)</span>
            <ExternalLink className="w-3.5 h-3.5" />
          </a>
        </div>

        {/* Album Header */}
        <div className="bg-white rounded-[28px] p-8 sm:p-10 border border-[#E8E2D8] shadow-[0_8px_30px_rgba(0,0,0,0.03)] mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 mb-12">
          ...
          {/* Item 2: Top Right Square/Vertical Photo (col-span-4) */}
          {photos[1] && (
            <div
