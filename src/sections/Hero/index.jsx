...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative w-full min-h-screen lg:h-screen lg:min-h-[720px] lg:max-h-[960px] 2xl:max-h-[1080px] flex flex-col justify-between pt-20 md:pt-24 pb-6 overflow-hidden bg-cream-100"
    >
      {/* Unified Hero Stage Container: Holds the entire layout in perfect laptop proportions on 4K & Ultra-wide displays */}
      <div className="relative max-w-[1400px] w-full mx-auto flex-1 flex flex-col justify-between px-6 sm:px-10 lg:px-12 z-10">
        
        {/* 1. Full-width Background Image Layer for Desktop (lg+) - Anchored to container so it never drifts on 4K */}
        <div
          data-darkreader-ignore="true"
          className="hero-bg-layer hidden lg:block absolute right-0 top-0 bottom-0 w-full lg:w-[62%] xl:w-[58%] 2xl:w-[55%] bg-no-repeat bg-right-top bg-contain pointer-events-none z-0"
          style={{
        ...
        <div className="hidden lg:block absolute right-6 sm:right-10 lg:right-12 xl:right-14 bottom-[108px] sm:bottom-[114px] lg:bottom-[120px] xl:bottom-[126px] w-[235px] xl:w-[250px] z-30">
          <CountdownCard className="countdown-card" />
        </div>
